...
/**
 * This is a JUnit testbed 
 * to put BookStore and ShoeStore through the wringer.
 * 
 * It is possible that the module will not compile with a mis-named method,
 * or in the case that a constructor has the incorrect type / order of parameters.
 * 
 * Number of the tests will attempt to break the solution
 * by giving null as a parameter.  If this test did not pass, it will fail
 ...
 * are not null before doing anything -- or write the code in such a way that null
...
public class TestAssignment1
{
    ...
    {
        final String EXPECTED = "Highest markup is 333.33333333333337%, for Surely You're Joking Mr. Feynman by Feynman"
            + NEWLINE + "";
